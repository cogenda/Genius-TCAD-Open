...
H_MATERIAL="physical_unit.h PMI.h atom.h"
H_ENUM="enum_data_location.h enum_data_type.h enum_solution.h"
H_BASE="base/genius_common.h base/std_ext.h base/genius_dll.h parser/parser_parameter.h utils/compare_types.h"
...
cp $BASEDIR/src/material/Si/*.cc $HERE/Si
cp $BASEDIR/src/material/4H-SiC/*.cc $HERE/4H-SiC
cp $BASEDIR/src/material/Epoxy/*.cc $HERE/Epoxy
