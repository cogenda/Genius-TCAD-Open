...
class GSS_SiC4H_Trap_Default : public PMIS_Trap
{
private:
  // {{{ class TrapSpec
  class TrapSpec
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_Trap* PMIS_SiC4H_Trap_Default (const PMIS_Environment& env)
  {
    return new GSS_SiC4H_Trap_Default(env);
  }
}
