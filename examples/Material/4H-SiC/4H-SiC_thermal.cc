...
private:
  ...
  void   Thermal_Init()
  {
     A_SP_HEA =  1.026000e+03*J/kg/K;
     B_SP_HEA =  0.201000e+00*J/kg/std::pow(K,2);
     C_SP_HEA =  0.000000e+00*J/kg/std::pow(K,3);
     D_SP_HEA = -3.660000e+07*J/kg*K;
     F_SP_HEA =  0.000000e+00*J/kg/std::pow(K,4);
     G_SP_HEA =  0.000000e+00*J/kg/std::pow(K,5);

     A_TH_CON =  2.500000e-03*cm*K/J*s;
     B_TH_CON =  2.750000e-04*cm/J*s;
     C_TH_CON =  1.300000e-06*cm/J*s/K;
