...
class GSS_Si_BasicParameter_Sdevice : public PMIS_BasicParameter
{
private:
...
public:
  ...
  GSS_Si_BasicParameter_Sdevice(const PMIS_Environment &env):PMIS_BasicParameter(env)
  {
    PMI_Info = "This is the Sdevice compatable basic physical parameters of Silicon";
    Basic_Init();
  }
  ~GSS_Si_BasicParameter_Sdevice()
  {
  }
}
;
...
extern "C"
{
  DLL_EXPORT_DECLARE PMIS_BasicParameter* PMIS_Si_BasicParameter_Sdevice (const PMIS_Environment& env)
  {
    return new GSS_Si_BasicParameter_Sdevice(env);
  }
}
