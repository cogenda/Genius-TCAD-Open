...
#ifndef __boundary_condition_rr_h__
#define __boundary_condition_rr_h__


#include "boundary_condition.h"

/**
 * The Resistance-to-Resistance interface, i.e. n-poly and p-poly contact
 */
class ResistanceResistanceBC : public BoundaryCondition
{
public:
   ...
   * constructor
   */
  ResistanceResistanceBC(SimulationSystem  & system, const std::string & label="");

  /**
   * destructor
   */
  virtual ~ResistanceResistanceBC(){}
