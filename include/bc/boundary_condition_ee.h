...
#ifndef __boundary_condition_ee_h__
#define __boundary_condition_ee_h__
...
/**
 * The electrode-to-electrode interface
 */
class ElectrodeElectrodeInterfaceBC : public BoundaryCondition
{
public:
   ...
   * constructor
   */
  ElectrodeElectrodeInterfaceBC(SimulationSystem  & system, const std::string & label="");

  /**
   * destructor
   */
  virtual ~ElectrodeElectrodeInterfaceBC(){}
