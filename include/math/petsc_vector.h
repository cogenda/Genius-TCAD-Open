// $Id: petsc_vector.h 2789 2008-04-13 02:24:40Z roystgnr $
...
public:
   ...
   * calling VecDestroy()!
   */
  Vec vec () { genius_assert (_vec != NULL); return _vec; }
...
void PetscVector<T>::clear ()
{
  if ((this->initialized()) && (this->_destroy_vec_on_exit))
  {
    ...
    ierr = VecDestroy(PetscDestroyObject(_vec));
  }
...
{
  genius_assert (this->initialized());
  genius_assert ( ((i >= this->first_local_index()) &&
