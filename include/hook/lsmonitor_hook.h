...
#ifndef __lsmonitor_hook_h__
#define __lsmonitor_hook_h__
...
/**
 * dump A x and b after each linear solve procedure
 */
class LinearSolverMonitorHook : public Hook
{

public:

  LinearSolverMonitorHook(SolverBase & solver, const std::string & name, void *);

  virtual ~LinearSolverMonitorHook();
