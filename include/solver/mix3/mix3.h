...
/**
 * Mixed type simulation with Level 3 Energy Balance Model equations
 */
class Mix3Solver : public MixSolverBase
{
public:
  Mix3Solver(SimulationSystem & system): MixSolverBase(system)
