...
#ifndef __fvm_cell_data_conductor_h__
#define __fvm_cell_data_conductor_h__
...
/**
 *  FVM cell data for conductor region
 */
class FVM_Conductor_CellData : public FVM_CellData
{
...
public:
   ...
   * constructor
   */
  FVM_Conductor_CellData(DataStorage * data_storage, const std::map<std::string, SimulationVariable> & variables)
   ...
   * destructor
   */
  virtual ~FVM_Conductor_CellData()  {}
