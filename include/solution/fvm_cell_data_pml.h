...
#ifndef __fvm_cell_data_pml_h__
#define __fvm_cell_data_pml_h__
...
/**
 *  FVM cell data for PML region
 */
class FVM_PML_CellData : public FVM_CellData
{
...
public:
   ...
   * constructor
   */
  FVM_PML_CellData(DataStorage * data_storage, const std::map<std::string, SimulationVariable> & variables)
