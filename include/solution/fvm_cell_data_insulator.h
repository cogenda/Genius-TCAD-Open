...
#ifndef __fvm_cell_data_insulator_h__
#define __fvm_cell_data_insulator_h__
...
/**
 *  FVM cell data for insulator region
 */
class FVM_Insulator_CellData : public FVM_CellData
{
...
public:
   ...
   * constructor
   */
  FVM_Insulator_CellData(DataStorage * data_storage, const std::map<std::string, SimulationVariable> & variables)
   ...
   * destructor
   */
  virtual ~FVM_Insulator_CellData()  {}
...
public:
  ...
  virtual CellDataType type() const
    { return FVM_CellData::InsulatorData; }
