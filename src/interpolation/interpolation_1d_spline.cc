...
void Interpolation1D_Spline::clear()
{
  _coordinate.clear();
  _values.clear();
...
void Interpolation1D_Spline::add_scatter_data(const Point & point, int group, double value)
{
  if(_coordinate.size())
...
void Interpolation1D_Spline::setup(int group)
{
...
void Interpolation1D_Spline::broadcast(unsigned int root)
{
