 ...
 */
int MeshGeneratorStruct::set_x_line ( const Parser::Card &c )
{
 ...
 */
int MeshGeneratorStruct::set_y_line ( const Parser::Card &c )
{
  // get parameter value from command structure
 ...
 */
int MeshGeneratorStruct::set_z_line ( const Parser::Card &c )
{
  // get parameter value from command structure
 ...
 */
int MeshGeneratorStruct::find_skeleton_line_x(double x)
{
  int ix=0;
  double dx=1e10;
 ...
 */
int MeshGeneratorStruct::find_skeleton_line_y(double y)
{
  int iy=0;
  double dy=1e10;
 ...
 */
int MeshGeneratorStruct::find_skeleton_line_z(double z)
{
  int iz=0;
  double dz=1e10;
