...
class GSS_NPolySi_Optical : public PMIC_Optical
{
private:
...
public:
  ...
  // constructions
public:
  GSS_NPolySi_Optical(const PMIC_Environment &env):PMIC_Optical(env)  {}
...
const RefractionItem GSS_NPolySi_Optical::WaveTable[] =
  {
    {0.1240,  0.466,  1.090},
    {0.1378,  0.499,  1.330},
    {0.1550,  0.554,  1.660},
...
const unsigned int GSS_NPolySi_Optical::table_size = sizeof(GSS_NPolySi_Optical::WaveTable)/sizeof(RefractionItem);


extern "C"
{
  DLL_EXPORT_DECLARE  PMIC_Optical*  PMIC_NPolySi_Optical_Default (const PMIC_Environment& env)
  {
    return new GSS_NPolySi_Optical(env);
  }
}
