...
public:
  ...
  {
    //0.0242*J/s/m/K;
    return 1.0/(A_TH_CON + B_TH_CON*Tl + C_TH_CON*T300*Tl + D_TH_CON*std::pow(Tl,E_TH_CON));
  }
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMII_Thermal* PMII_Air_Thermal_Default (const PMII_Environment& env)
  {
