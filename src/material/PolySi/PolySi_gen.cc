...
class GSS_PolySi_Avalanche_Default : public PMIS_Avalanche
{
private:
...
public:
  ...
  GSS_PolySi_Avalanche_Default(const PMIS_Environment &env):PMIS_Avalanche(env)
  {
    PMI_Info = "This is the Default impact ionization model of Silicon";
    Avalanche_Init();
  }
  ~GSS_PolySi_Avalanche_Default()
  {
  }
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_Avalanche* PMIS_PolySi_Avalanche_Selberherr (const PMIS_Environment& env)
  {
    return new GSS_PolySi_Avalanche_Default(env);
  }
  DLL_EXPORT_DECLARE  PMIS_Avalanche* PMIS_PolySi_Avalanche_Default (const PMIS_Environment& env)
  {
    return new GSS_PolySi_Avalanche_Default(env);
  }
}
