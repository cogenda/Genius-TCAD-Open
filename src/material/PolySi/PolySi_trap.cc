...
class GSS_PolySi_Trap_Default : public PMIS_Trap
{
private:
  // {{{ class TrapSpec
  class TrapSpec
...
public:
  ...
  GSS_PolySi_Trap_Default(const PMIS_Environment &env):PMIS_Trap(env)
  {
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_Trap* PMIS_PolySi_Trap_Default (const PMIS_Environment& env)
  {
    return new GSS_PolySi_Trap_Default(env);
  }
}
