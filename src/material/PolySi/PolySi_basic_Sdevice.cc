...
class GSS_PolySi_BasicParameter_Sdevice : public PMIS_BasicParameter
{
private:
...
public:
  ...
  GSS_PolySi_BasicParameter_Sdevice(const PMIS_Environment &env):PMIS_BasicParameter(env)
  {
    PMI_Info = "This is the Default model for basic physical parameters of Poly Silicon";
    Basic_Init();
  }
  ~GSS_PolySi_BasicParameter_Sdevice()
  {
  }
}
;
...
extern "C"
{
  DLL_EXPORT_DECLARE PMIS_BasicParameter* PMIS_PolySi_BasicParameter_Sdevice (const PMIS_Environment& env)
  {
    return new GSS_PolySi_BasicParameter_Sdevice(env);
  }
}
