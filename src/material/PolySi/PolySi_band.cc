...
class GSS_PolySi_BandStructure : public PMIS_BandStructure
{
private:
  PetscScalar T300;
  //[Bandgap]
...
public:
  GSS_PolySi_BandStructure(const PMIS_Environment &env):PMIS_BandStructure(env)
  {
    T300 = 300.0*K;
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_BandStructure*  PMIS_PolySi_BandStructure_Default (const PMIS_Environment& env)
  {
    return new GSS_PolySi_BandStructure(env);
  }
}
