...
class GSS_PolySi_BasicParameter : public PMIS_BasicParameter
{
private:
...
public:
  ...
  GSS_PolySi_BasicParameter(const PMIS_Environment &env):PMIS_BasicParameter(env)
  {
...
extern "C"
{
  DLL_EXPORT_DECLARE PMIS_BasicParameter* PMIS_PolySi_BasicParameter_Default (const PMIS_Environment& env)
  {
