...
const RefractionItem GSS_PolySi_Optical::WaveTable[] =
  {
    {0.1240,  0.466,  1.090},
    {0.1378,  0.499,  1.330},
    {0.1550,  0.554,  1.660},
...
const unsigned int GSS_PolySi_Optical::table_size = sizeof(GSS_PolySi_Optical::WaveTable)/sizeof(RefractionItem);


extern "C"
{
  DLL_EXPORT_DECLARE  PMIC_Optical*  PMIC_PolySi_Optical_Default (const PMIC_Environment& env)
  {
