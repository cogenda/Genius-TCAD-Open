...
class GSS_PolySi_Thermal : public PMIS_Thermal
{
private:
...
public:
  GSS_PolySi_Thermal(const PMIS_Environment &env):PMIS_Thermal(env)
  {
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_Thermal* PMIS_PolySi_Thermal_Default (const PMIS_Environment& env)
  {
