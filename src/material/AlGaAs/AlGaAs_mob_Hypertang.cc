...
class GSS_AlGaAs_Mob_Hypertang : public PMIS_Mobility
{
private:
...
public:
  GSS_AlGaAs_Mob_Hypertang(const PMIS_Environment &env):PMIS_Mobility(env)
  {
    Mob_Hypertang_Init();
  }


  ~GSS_AlGaAs_Mob_Hypertang()
  {
  }
...
extern "C"
{
  ...
  {
    return new GSS_AlGaAs_Mob_Hypertang(env);
  }
}
/* alias */
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_Mobility* PMIS_AlGaAs_Mob_Hypertang (const PMIS_Environment& env)
  {
    return new GSS_AlGaAs_Mob_Hypertang(env);
  }
}
