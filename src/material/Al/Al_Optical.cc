...
const RefractionItem GSS_Al_Optical::WaveTable[] =
  {
    {0.0165,  1.010,  0.024},
    {0.0172,  1.020,  0.0035},
    {0.0376,  0.902,  0.0102},
...
const unsigned int GSS_Al_Optical::table_size = sizeof(GSS_Al_Optical::WaveTable)/sizeof(RefractionItem);


extern "C"
{
  DLL_EXPORT_DECLARE  PMIC_Optical*  PMIC_Al_Optical_Default (const PMIC_Environment& env)
  {
