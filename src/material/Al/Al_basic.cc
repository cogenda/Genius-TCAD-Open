...
private:
  ...
  void   Basic_Init()
  {
    ...
    IONDENSITY  = 1.817688e+23*std::pow(cm,-3);
    // reported value from 2.6 micro ohms to 4.0 micro ohms. however, thin conductance may have larger resistance
    CONDUCTANCE = 1.0/(1e-5*V/A*cm);
