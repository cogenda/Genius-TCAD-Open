...
class GSS_PPolySi_Thermal : public PMIC_Thermal
{
private:
...
public:
  ...
  GSS_PPolySi_Thermal(const PMIC_Environment &env):PMIC_Thermal(env)
  {
    Thermal_Init();
  }
  ~GSS_PPolySi_Thermal()
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIC_Thermal* PMIC_PPolySi_Thermal_Default (const PMIC_Environment& env)
  {
    return new GSS_PPolySi_Thermal(env);
  }
}
