...
class GSS_Ge_Mob_Analytic : public PMIS_Mobility
{
private:
...
public:
  GSS_Ge_Mob_Analytic(const PMIS_Environment &env):PMIS_Mobility(env)
  {
    Mob_Analytic_Init();
  }
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_Mobility* PMIS_Ge_Mob_Default (const PMIS_Environment& env)
  {
    return new GSS_Ge_Mob_Analytic(env);
  }
}
/* alias */
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_Mobility* PMIS_Ge_Mob_Analytic (const PMIS_Environment& env)
  {
    return new GSS_Ge_Mob_Analytic(env);
  }
}
