...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_Avalanche* PMIS_Ge_Avalanche_Selberherr (const PMIS_Environment& env)
  {
    return new GSS_Ge_Avalanche(env);
  }
  DLL_EXPORT_DECLARE  PMIS_Avalanche* PMIS_Ge_Avalanche_Default (const PMIS_Environment& env)
  {
    return new GSS_Ge_Avalanche(env);
  }
}
