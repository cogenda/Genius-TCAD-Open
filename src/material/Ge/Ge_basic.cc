...
private:
  ...
  void   Basic_Init()
  {
    ...
    DENSITY  = 5.330000e-03*kg*std::pow(cm,-3);
...
public:
  ...
  {
    atoms.push_back(Atom("Germanium", "Ge", 32, 72.59));//Germanium
...
extern "C"
{
  DLL_EXPORT_DECLARE  PMIS_BasicParameter* PMIS_Ge_BasicParameter_Default (const PMIS_Environment& env)
  {
