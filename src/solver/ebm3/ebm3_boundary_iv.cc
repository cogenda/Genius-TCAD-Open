 ...
 */
void InsulatorVacuumInterfaceBC::EBM3_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for EBM3 solver
 */
void InsulatorVacuumInterfaceBC::EBM3_Jacobian(PetscScalar * x, SparseMatrix<PetscScalar> *jac, InsertMode &add_value_flag)
{
  // Neumann boundary condition is processed here
  const PetscScalar Heat_Transfer = this->scalar("heat.transfer");
