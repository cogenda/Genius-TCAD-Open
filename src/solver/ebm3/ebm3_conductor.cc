 ...
 */
unsigned int ConductorSimulationRegion::ebm_n_variables() const
{
 ...
 */
unsigned int ConductorSimulationRegion::ebm_variable_offset(SolutionVariable var) const
{
  switch(var)
  {
...
void ConductorSimulationRegion::EBM3_Fill_Value(Vec x, Vec L)
{
 ...
 */
void ConductorSimulationRegion::EBM3_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for EBM3 solver
 */
void ConductorSimulationRegion::EBM3_Jacobian(PetscScalar * x, Mat *jac, InsertMode &add_value_flag)
{
...
void ConductorSimulationRegion::EBM3_Time_Dependent_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
...
void ConductorSimulationRegion::EBM3_Time_Dependent_Jacobian(PetscScalar * x, Mat *jac, InsertMode &add_value_flag)
{
...
void ConductorSimulationRegion::EBM3_Update_Solution(PetscScalar *lxx)
{
