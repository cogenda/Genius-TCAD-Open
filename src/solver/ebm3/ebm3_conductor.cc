 ...
 */
unsigned int ElectrodeSimulationRegion::ebm_n_variables() const
{
 ...
 */
unsigned int ElectrodeSimulationRegion::ebm_variable_offset(SolutionVariable var) const
{
  switch(var)
  {
...
void ElectrodeSimulationRegion::EBM3_Fill_Value(Vec x, Vec L)
{
 ...
 */
void ElectrodeSimulationRegion::EBM3_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
...
void ElectrodeSimulationRegion::EBM3_Time_Dependent_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
...
void ElectrodeSimulationRegion::EBM3_Update_Solution(PetscScalar *lxx)
{
