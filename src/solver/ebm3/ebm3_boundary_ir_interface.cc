 ...
 */
void ResistanceInsulatorBC::EBM3_Jacobian_Reserve(Mat *jac, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for EBM3 solver
 */
void ResistanceInsulatorBC::EBM3_Jacobian(PetscScalar * x, Mat *jac, InsertMode &add_value_flag)
{
