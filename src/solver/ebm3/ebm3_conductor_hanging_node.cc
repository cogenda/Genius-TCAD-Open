...
void ConductorSimulationRegion::EBM3_Function_Hanging_Node(PetscScalar *x, Vec f, InsertMode &add_value_flag)
{
...
void ConductorSimulationRegion::EBM3_Jacobian_Hanging_Node(PetscScalar *x, Mat *jac, InsertMode &add_value_flag)
{
