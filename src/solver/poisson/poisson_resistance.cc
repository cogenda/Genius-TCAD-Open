 ...
 */
void MetalSimulationRegion::Poissin_Fill_Value(Vec x, Vec L)
{
  std::vector<int> ix;
...
void MetalSimulationRegion::Poissin_Update_Solution(PetscScalar *lxx)
{
  ...
  // the electrical field is always zero here.
