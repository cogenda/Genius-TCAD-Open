    ...
    for(unsigned int i=0 ; rnode_it!=end_rnode_it; ++i, ++rnode_it  )
    {
      ...
      else
      {
...

        {
          ...
          PetscInt imag_row = fvm_nodes[i]->global_offset() + n_node_var + node_psi_offset;
          PetscInt real_col[2]={real_row, fvm_nodes[0]->global_offset() + regions[0]->ebm_variable_offset(POTENTIAL)};
          PetscInt imag_col[2]={imag_row, fvm_nodes[0]->global_offset() + n_node_var_0 + regions[0]->ebm_variable_offset(POTENTIAL)};
        ...
        if(regions[i]->get_advanced_model()->enable_Tl())
        {
          ...
          PetscInt imag_row = fvm_nodes[i]->global_offset() + n_node_var + node_Tl_offset;
          PetscInt real_col[2]={real_row, fvm_nodes[0]->global_offset() + regions[0]->ebm_variable_offset(TEMPERATURE)};
          PetscInt imag_col[2]={imag_row, fvm_nodes[0]->global_offset() + n_node_var_0 + regions[0]->ebm_variable_offset(TEMPERATURE)};
