...
void ElectrodeSimulationRegion::DDMAC_Fill_Value(Vec x, Vec L) const
{
...
void ElectrodeSimulationRegion::DDMAC_Fill_Matrix_Vector(Mat A, Vec b, const Mat J, const PetscScalar omega,  InsertMode &add_value_flag) const
{
...
void ElectrodeSimulationRegion::DDMAC_Fill_Transformation_Matrix ( Mat T, const Mat J, const PetscScalar omega,  InsertMode &add_value_flag ) const
{
...
void ElectrodeSimulationRegion::DDMAC_Fill_Nodal_Matrix_Vector(
...
void ElectrodeSimulationRegion::DDMAC_Force_equal(const FVM_Node *fvm_node, Mat A, InsertMode & add_value_flag,
...
void ElectrodeSimulationRegion::DDMAC_Force_equal(const FVM_Node *fvm_node, const SolutionVariable var, Mat A, InsertMode & add_value_flag,
    const SimulationRegion * adjacent_region, const FVM_Node * adjacent_fvm_node) const
{
  genius_assert(add_value_flag == ADD_VALUES);
...
void ElectrodeSimulationRegion::DDMAC_Update_Solution(PetscScalar *lxx)
{
