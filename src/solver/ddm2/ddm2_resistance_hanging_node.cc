...
void MetalSimulationRegion::DDM2_Function_Hanging_Node(PetscScalar *x, Vec f, InsertMode &add_value_flag)
{
...
void MetalSimulationRegion::DDM2_Jacobian_Hanging_Node(PetscScalar *x, Mat *jac, InsertMode &add_value_flag)
{
  if( !has_2d_hanging_node() && !has_3d_hanging_node()  ) return;
