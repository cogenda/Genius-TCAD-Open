 ...
 */
void ResistanceInsulatorBC::DDM2_Fill_Value(Vec , Vec L)
{
 ...
 */
void ResistanceInsulatorBC::DDM2_Function_Preprocess(Vec f, std::vector<PetscInt> &src_row,
 ...
 */
void ResistanceInsulatorBC::DDM2_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
 ...
 */
void ResistanceInsulatorBC::DDM2_Jacobian_Preprocess(Mat *jac, std::vector<PetscInt> &src_row,
    std::vector<PetscInt> &dst_row, std::vector<PetscInt> &clear_row)
{
  BoundaryCondition::const_node_iterator node_it = nodes_begin();
  BoundaryCondition::const_node_iterator end_it = nodes_end();
 ...
 * update electrode IV
 */
void ResistanceInsulatorBC::DDM2_Update_Solution(PetscScalar *)
{
