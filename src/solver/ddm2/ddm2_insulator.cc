...
void InsulatorSimulationRegion::DDM2_Fill_Value(Vec x, Vec L)
{
  std::vector<int> ix;
 ...
 */
void InsulatorSimulationRegion::DDM2_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for DDML2 solver
 */
void InsulatorSimulationRegion::DDM2_Jacobian(PetscScalar * x, SparseMatrix<PetscScalar> *jac, InsertMode &add_value_flag)
{
...
void InsulatorSimulationRegion::DDM2_Time_Dependent_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
  // note, we will use ADD_VALUES to set values of vec f
...
void InsulatorSimulationRegion::DDM2_Time_Dependent_Jacobian(PetscScalar * x, SparseMatrix<PetscScalar> *jac, InsertMode &add_value_flag)
{
...
void InsulatorSimulationRegion::DDM2_Update_Solution(PetscScalar *lxx)
{
