 ...
 */
void ElectrodeSimulationRegion::DDM2_Fill_Value(Vec x, Vec L)
{
  std::vector<int> ix;
 ...
 */
void ElectrodeSimulationRegion::DDM2_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
...
void ElectrodeSimulationRegion::DDM2_Time_Dependent_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
...
void ElectrodeSimulationRegion::DDM2_Update_Solution(PetscScalar *lxx)
{
