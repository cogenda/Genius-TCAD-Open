 ...
 */
void OhmicContactBC::DDM1_Function_Preprocess(Vec f, std::vector<PetscInt> &src_row,
 ...
 */
void OhmicContactBC::DDM1_Jacobian_Preprocess(Mat *jac, std::vector<PetscInt> &src_row,  std::vector<PetscInt> &dst_row, std::vector<PetscInt> &clear_row)
{
