...
void MetalSimulationRegion::DDM1_Function_Hanging_Node(PetscScalar *x, Vec f, InsertMode &add_value_flag)
{
...
void MetalSimulationRegion::DDM1_Jacobian_Hanging_Node(PetscScalar *x, Mat *jac, InsertMode &add_value_flag)
{
