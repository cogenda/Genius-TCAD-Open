 ...
 */
void SimpleGateContactBC::DDM1_Fill_Value(Vec x, Vec L)
{
 ...
 */
void SimpleGateContactBC::DDM1_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
 ...
 */
void SimpleGateContactBC::DDM1_Jacobian_Reserve(Mat *jac, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for DDM L1 solver
 */
void SimpleGateContactBC::DDM1_Jacobian(PetscScalar * x, Mat *jac, InsertMode &add_value_flag)
{
