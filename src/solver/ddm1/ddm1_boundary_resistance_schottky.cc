 ...
 */
void IF_Metal_SchottkyBC::DDM1_Jacobian_Reserve(Mat *jac, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for DDML1 solver
 */
void IF_Metal_SchottkyBC::DDM1_Jacobian(PetscScalar * x, Mat *jac, InsertMode &add_value_flag)
{
