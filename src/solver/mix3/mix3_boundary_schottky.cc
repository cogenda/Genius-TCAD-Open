 ...
 */
void SchottkyContactBC::Mix_EBM3_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
 ...
 */
void SchottkyContactBC::Mix_EBM3_Jacobian_Reserve(Mat *jac, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for Mixed EBM3 solver
 */
void SchottkyContactBC::Mix_EBM3_Jacobian(PetscScalar * x, Mat *jac, InsertMode &add_value_flag)
{
...
void SchottkyContactBC::Mix_EBM3_Electrode_Load(const Vec lx, const Mat *, double & I, PetscScalar & pdI_pdV, Vec & pdI_pdx, Vec & pdF_pdV)
{
