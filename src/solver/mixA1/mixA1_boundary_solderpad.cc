 ...
 */
void SolderPadBC::MixA_DDM1_Jacobian_Reserve(Mat *jac, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for Mixed DDML1 solver
 */
void SolderPadBC::MixA_DDM1_Jacobian(PetscScalar * x, Mat *jac, InsertMode &add_value_flag)
{
