...
void ElectrodeSimulationRegion::LinearPoissin_RHS(Vec b, InsertMode &add_value_flag)
{
...
void ElectrodeSimulationRegion::LinearPoissin_Matrix(Mat A, InsertMode &add_value_flag)
{
...
void ElectrodeSimulationRegion::LinearPoissin_Update_Solution(const PetscScalar * x)
{
