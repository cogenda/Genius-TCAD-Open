 ...
 */
void OhmicContactBC::Mix_DDM1_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
  ...
  // we only need to performance ohmic bc to corresponding mesh nodes.
  // ngspice will deal with circuit problem
 ...
 */
void OhmicContactBC::Mix_DDM1_Jacobian_Reserve(Mat *jac, InsertMode &add_value_flag)
{
 ...
 * build function and its jacobian for Mixed DDML1 solver
 */
void OhmicContactBC::Mix_DDM1_Jacobian(PetscScalar * x, Mat *jac, InsertMode &add_value_flag)
{
...
void OhmicContactBC::Mix_DDM1_Electrode_Load(const Vec , const Mat * jac, double & I, PetscScalar & pdI_pdV, Vec & pdI_pdx, Vec & pdF_pdV)
{
