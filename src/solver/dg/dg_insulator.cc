...
unsigned int InsulatorSimulationRegion::dg_n_variables() const
{
  return 1;
}


unsigned int InsulatorSimulationRegion::dg_variable_offset(SolutionVariable var) const
{
...
void InsulatorSimulationRegion::DG_Fill_Value(Vec x, Vec L)
{
  this->DDM1_Fill_Value(x, L);
}


void InsulatorSimulationRegion::DG_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
...
void InsulatorSimulationRegion::DG_Time_Dependent_Function(PetscScalar * x, Vec f, InsertMode &add_value_flag)
{
...
void InsulatorSimulationRegion::DG_Update_Solution(PetscScalar *lxx)
{
